...
@property (nonatomic, assign) float                 fps;            //视频fps
...
typedef NS_ENUM(NSInteger, TXGenerateResultCode)
{
    ...
    GENERATE_RESULT_LICENCE_VERIFICATION_FAILED          = -5,      //licence 验证失败
};
...
typedef NS_ENUM(NSInteger, TXJoinerResultCode)
{
    ...
    JOINER_RESULT_LICENCE_VERIFICATION_FAILED       = -5,           //licence 验证失败
};
/*
 * 短视频合成结果
 */
