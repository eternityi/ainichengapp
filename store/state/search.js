...
export const search = Record({
	...
	histories: [{ id: 1, keywords: "辣椒炒肉" }, { id: 2, keywords: "拍黄瓜" }, { id: 3, keywords: "网红饭" }],
	search_detail: {
		users: [
			{
				id: 1,
		...
		articles: [
			{
				...
				title: "家常菜谱 | 剁椒蒜苗",
				description: "有一句老话叫“雨后春笋茁壮成长”，一场春雨过后，市场上随处可见，物美价廉的寻常人家美味。咱又买了一根，吃时令蔬菜，顺应时令才是科学养生之道。春笋洁白如玉、笋体肥大、鲜嫩清香、鲜美脆嫩，被誉为“素食第一品”、 “菜王”。"
			},
			{
				id: 2,
				user: {
				...
				description: "有一句老话叫“雨后春笋茁壮成长”，一场春雨过后，市场上随处可见，也就是小白菜的价格了。咱又买了一根，吃时令蔬菜，顺应时令才是科学养生之道。春笋洁白如玉、笋体肥大、鲜嫩清香、鲜美脆嫩，被誉为“素食第一品”、 “美味菜王”。"
			},
			{
				id: 3,
				user: {
				...
				description: "有一句老话叫“雨后春笋茁壮成长”，一场春雨过后，市场上随处美味，也就是小白菜的价格了。咱又买了一根，吃时令蔬菜，顺应时令才是科学养生之道。春笋洁白如玉、笋体肥大、鲜嫩清香、美味脆嫩，被誉为“素食第一品”、 “菜王”。"
			},
			{
				id: 4,
				user: {
				...
				title: "养生美味 | 韭黄炒南极磷虾 — 具健胃、提神、止汗固涩、补肾助阳、固精等功效",
				description: "有一句老话叫“雨后春笋茁壮成长”，一场春雨过后，市场上随处可见的美味，也就是小白菜的价格了。咱又买了一根，吃时令蔬菜，顺应时令才是科学养生之道。春笋洁白如玉、笋体肥大、鲜嫩清香、鲜美脆嫩，被誉为“素食第一品”、 “菜王”。"
			},
			{
				id: 5,
				user: {
				...
				description: "有一句老话叫“雨后春笋茁壮成长”，一场春雨过后，市场上随处可见，也就是小白菜的价格了。咱又买了一根美味，吃时令蔬菜，顺应时令才是科学养生之道。春笋洁白如玉、笋体肥大、鲜嫩清香、鲜美脆嫩，被誉为“素食第一品”、 “菜王”。"
			},
			{
				id: 6,
				user: {
