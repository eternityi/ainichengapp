									...
									<View style={styles.visitingCard}>
										...
										<View style={{ alignItems: "center" }}>
											<View style={{ marginTop: -10 }}>
												<Avatar uri={user.avatar} size={90} borderStyle={{ borderColor: "#fff", borderWidth: 2 }} />
											</View>
											<View style={{ marginTop: 5 }}>
												<Text style={{ fontSize: 22, fontWeight: "500", color: Colors.primaryFontColor }}>{user.name}</Text>
											</View>
