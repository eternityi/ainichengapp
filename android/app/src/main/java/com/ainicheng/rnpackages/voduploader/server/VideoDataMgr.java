...
//import com.tencent.liteav.basic.log.TXLog;
import com.ainicheng.common.utils.TCConstants;
import com.ainicheng.common.utils.TCUtils;
...
public class VideoDataMgr {
    ...
    private void parseSigRes(String sigRes) {
        ...
        notifyGetPublishSigSuccess(sigRes);
//        try {
...
//        }
    ...
    public void getVideoInfo() {
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                Log.e(TAG, "getVideoInfo onFailure : " + e.toString());
            }

            @Override
            public void onResponse(Call call, Response response) throws IOException {
                Log.i(TAG, "getVideoInfo onResponse : " + response.body().string());
//                parseVideoInfo();
            }
        });
    }
    ...
    //import com.ainicheng.play.superplayer.SuperPlayerModel;
